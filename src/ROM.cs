...
namespace Quad64
{
    ...
    class ROM
    {
        ...
        public Dictionary<string, ushort> levelIDs = new Dictionary<string, ushort>
        {
            ...
            { "[S1] The Princess's Secret Slide", 0x1B },
            { "[S2] The Secret Aquarium", 0x14 },
            { "[S3] Wing Mario Over the Rainbow", 0x1F },
            { "[S4] End Cake Picture", 0x19 },
            { "[MC] Metal Cap", 0x1C },
            { "[VC] Vanish Cap", 0x12 },
            { "[WC] Wing Cap", 0x1D },
            { "[B1] Bowser Course 1", 0x11 },
            { "[B2] Bowser Course 2", 0x13 },
            { "[B3] Bowser Course 3", 0x15 },
            { "[F1] Bowser Fight 1", 0x1E },
            { "[F2] Bowser Fight 2", 0x21 },
            { "[F3] Bowser Fight 3", 0x22 },
